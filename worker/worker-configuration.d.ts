/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=worker/wrangler.jsonc worker/worker-configuration.d.ts` (hash: 624e6421e11ead5ee09db4f92c7b8632)
// Runtime types generated with workerd@1.20260811.1 2026-08-16 nodejs_compat
interface __BaseEnv_Env {
	ANALYZE_CLIENT_RATE_LIMITER: RateLimit;
	ANALYZE_GLOBAL_RATE_LIMITER: RateLimit;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_BASE_URL" | "AI_PRIMARY_MODEL" | "AI_TIMETABLE_MODEL" | "AI_VERIFIER_MODEL" | "ALLOWED_PRODUCTION_ORIGIN" | "FEATHERLESS_API_KEY">> {}
}
