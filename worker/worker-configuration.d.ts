/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=worker/wrangler.jsonc worker/worker-configuration.d.ts` (hash: 1f589380f994fa96a8ca3aa44d3028cf)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_BASE_URL" | "AI_PRIMARY_MODEL" | "AI_VERIFIER_MODEL" | "ALLOWED_PRODUCTION_ORIGIN" | "FEATHERLESS_API_KEY">> {}
}
